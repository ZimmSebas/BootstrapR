...
for (i in 1:b){
  ...
  if( (as.integer(BootsRango[i,1])+1) < 1)
  ...
  if ((as.integer(ShewartRango[i,1]))+1 < 1 )
    AlphaShewartRango[i,1] = 0
  else
    AlphaShewartRango[i,1] = rangacum[(as.integer(ShewartRango[i,1]))+1]
...
(qplot(vargrafico,probgraph[n,],color=13,main="Distribucion de sumas",xlab="Suma",ylab="Probabilidad", ylim = c(0.0000000000001,max(probgraph[n,]))) + geom_vline(xintercept = mean(ShewartMedia[,1]), colour="green") + geom_vline(xintercept = mean(ShewartMedia[,2]), colour = "red") )

#Grafico Shewart Rango
(qplot(0:rangomaxi,resrango,color=13,main="Distribucion de rango",xlab="Rango",ylab="Probabilidad",ylim = c(0.0000000000001,max(resrango))) + geom_vline(xintercept = mean(ShewartRango[,1]), colour="green") + geom_vline(xintercept = mean(ShewartRango[,2]), colour = "red" ) )

#Grafico Bootstrap Media
(qplot(vargrafico,probgraph[n,],color=13,main="Distribucion de sumas",xlab="Suma",ylab="Probabilidad",ylim = c(0.0000000000000000001,max(probgraph[n,]))) + geom_vline(xintercept = mean(BootsMedia[,1]), colour="green") + geom_vline(xintercept = mean(BootsMedia[,2]), colour = "red" ) )

#Grafico Bootstrap Rango
(qplot(0:rangomaxi,resrango,color=13,main="Distribucion de rango",xlab="Suma",ylab="Probabilidad", ylim = c(0.0000000000001,max(resrango))) + geom_vline(xintercept = mean(BootsRango[,1]), colour="green") + geom_vline(xintercept = mean(BootsRango[,2]), colour = "red" ) )


#Distribucion probabilidad0...
qplot(vargrafico,probgraph[n,],color=13,main="Distribucion de sumas",xlab="Suma",ylab="Probabilidad",ylim = c(0.0000000000000000001,max(probgraph[n,])))

write.table(AlphaBootsMedia,"Alpha Bootstrap Media.txt",sep = "\t",row.names = FALSE, col.names = c("Alfa inferior", "Alfa superior"))
write.table(AlphaBootsRango,"Alpha Bootstrap Rango.txt",sep = "\t",row.names = FALSE, col.names = c("Alfa inferior", "Alfa superior"))
write.table(AlphaShewartMedia,"Alpha Shewart Media.txt",sep = "\t",row.names = FALSE, col.names = c("Alfa inferior", "Alfa superior"))
write.table(AlphaShewartRango,"Alpha Shewart Rango.txt",sep = "\t",row.names = FALSE, col.names = c("Alfa inferior", "Alfa superior"))

write.table(BootsMedia,"Limite Bootstrap Media.txt",sep = "\t",row.names = FALSE, col.names = c("Limite inferior", "Limite superior"))
write.table(BootsRango,"Limite Bootstrap Rango.txt",sep = "\t",row.names = FALSE, col.names = c("Limite inferior", "Limite superior"))
write.table(ShewartMedia,"Limite Shewart Media.txt",sep = "\t",row.names = FALSE, col.names = c("Limite inferior", "Limite superior"))
write.table(ShewartRango,"Limite Shewart Rango.txt",sep = "\t",row.names = FALSE, col.names = c("Limite inferior", "Limite superior"))
