...
for (l in 1:b){
  ...
  BootsMedia[l,1] <- mediamuestral[as.integer(2000*0.025)]
  BootsMedia[l,2] <- mediamuestral[as.integer(2000*0.975)]
}

ShewartRango[1] <- r+3*d3[n]*alpha
ShewartRango[2] <- r-3*d3[n]*alpha
